...
public abstract class DateUtil {
    ...
    public static final String DATE_TIME_PATTERN_CH = DATE_PATTERN_CH + " " + TIME_PATTERN;
    ...
    public static void main(String[] args) {
        System.out.println(DateUtil.formatDate(new Date(),DateUtil.DATE_TIME_PATTERN_CH));
    }
}