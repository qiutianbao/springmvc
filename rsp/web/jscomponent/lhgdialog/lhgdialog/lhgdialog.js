							...
							'<td colspan="2">' +
								'<div class="ui_title_bar">' +
									...
									'<div class="ui_title_buttons">' +
										...
										'<a class="ui_close" href="javascript:void(0);" >\xd7</a>' +  // update by jameson.fang in the 2014-4-12 去掉 提示 title="\u5173\u95ED(esc\u952E)"
									'</div>' +
								'</div>' +
							'</td>' +
						'</tr>' +
...
lhgdialog.fn = lhgdialog.prototype =
{
	...
	focus: function()
	{
        ...
        try{
            elemFocus = this._focus && this._focus[0] ;//update date in the 2014-4-12 by jameson.fang 去掉close 关闭按钮聚焦，则Esc 退出键无效了 (|| this.DOM.close[0] ) 将 elemFocus = this._focus && this._focus[0] || this.DOM.close[0] 改为 elemFocus = this._focus && this._focus[0]
