...
(function ($) {
	...
	$.jstree = {
		...
		_instance : function (index, container, settings) { 
			...
			this.getAttr	= settings.attributes;//自定义属性，可为json对象	2011-08-17 evan.ban
	...
	$.jstree.plugin("core", {
		...
		_fn : { 
			...
			set_focus_node	: function (obj, id_mode) {//按节点提取其父节点 cheney 2011-11-30 
                obj = this._get_node(obj);
				if(this.is_focused()) { return; }
				var f = $.jstree._focused();
				if(f) { f.unset_focus(); }
			...
			get_parent		: function (obj, id_mode) {//按节点提取其父节点 cheney 2011-11-30 
				obj = this._get_node(obj);
				if(obj == -1 || !obj.length) { return false; }
				var o = obj.parentsUntil(".jstree", "li:eq(0)");
				return o.length ? o : -1;
			...
			get_children	: function (obj, id_mode) {//按节点提取其子节点 cheney 2011-11-30 
				obj = this._get_node(obj);
				if(obj === -1) { return this.get_container().children("ul:eq(0)").children("li"); }
				if(!obj.length) { return false; }
				return obj.children("ul:eq(0)").children("li");
			...
			get_id_path		: function (obj, id_mode) {//按id取得当前节点的ID的路径 cheney 2011-10-28 
				var p = [],
					_this = this;
				obj = this._get_node(obj);
				if(obj === -1 || !obj || !obj.length) { return false; }
	...
	$.jstree.plugin("crrm", { 
		...
		_fn : {
			...
			remove : function (obj) {
				...
				if(obj !== false) { 
					this.__callback({ "obj" : obj, "parent" : p , "prev" : p}); }
			},
			remove_node : function (obj) {
				obj = this._get_node(obj, true);
...
function selectFirstNode(){
    if($(".jstree-leaf a")!=null && $(".jstree-leaf a").size()>0 
	    && $(".jstree-leaf a").get(0)!=null 
	    && $($(".jstree-leaf a").get(0)).html()!='<ins class="jstree-icon">&nbsp;</ins>Loading ...'){
	        $($(".jstree-leaf a").get(0)).click();
    }else{
        setTimeout("selectFirstNode();",200);
    }
}
/**
 * 依次展开第一个节点，并选中最后一个节点
 */
function expandFirstNode(treeId){
    if($(".jstree-leaf a")!=null && $(".jstree-leaf a").size()>0 
	    && $(".jstree-leaf a").get(0)!=null 
	    && $($(".jstree-leaf a").get(0)).html()!='<ins class="jstree-icon">&nbsp;</ins>Loading ...'){
	        $($(".jstree-leaf a").get(0)).click();
