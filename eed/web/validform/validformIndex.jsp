...
<head>
    ...
    <link href="<%=path%>/validform/css/style.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="<%=path%>/validform/css/demo.css" type="text/css" rel="stylesheet" />
</head>
...
<script type="text/javascript" src="<%=path%>/validform/js/jquery-1.6.2.min.js"></script>
<script type="text/javascript" src="<%=path%>/validform/js/Validform_v5.3.2_min.js"></script>

<script type="text/javascript" src="<%=path%>/validform/js/passwordStrength-min.js"></script>
