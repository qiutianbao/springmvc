...
(function (d, f, b) {
    ...
    var e = {tit: "请填写信息", w: {"*": "请填写信息", "*6-16": "密码至少6个字符,最多18个字符！", "n": "密码至少6个字符,最多18个字符！", "n6-16": "璇峰～鍐�6鍒�16浣嶆暟瀛楋紒", "s": "密码至少6个字符,最多18个字符！", "s6-18": "密码至少6个字符,最多18个字符！", "p": "密码至少6个字符,最多18个字符！", "m": "密码至少6个字符,最多18个字符！", "e": "閭鍦板潃鏍煎紡涓嶅锛�", "url": "璇峰～鍐欑綉鍧€锛�"}, def: "璇峰～鍐欐纭俊鎭紒", undef: "datatype鏈畾涔夛紒", reck: "涓ゆ杈撳叆鐨勫唴瀹逛笉涓€鑷达紒", r: "閫氳繃淇℃伅楠岃瘉锛�", c: "姝ｅ湪妫€娴嬩俊鎭€�", s: "璇穥濉啓|閫夋嫨}{0|淇℃伅}锛�", v: "鎵€濉俊鎭病鏈夌粡杩囬獙璇侊紝璇风◢鍚庘€�", p: "姝ｅ湪鎻愪氦鏁版嵁鈥�"};
    d.Tipmsg = e;
